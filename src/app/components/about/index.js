    ...
    <section className='py-20 w-full'>
        ...
        <ItemLayout className="col-span-full lg:col-span-8 row-span-2 flex-col items-start" >
             ...
             <p className="font-light text-xs sm:text-sm md:text-base">
                 ...
                 casting the core of my Enhancements. I wield frameworks like React.js with precision, crafting seamless portals (websites)
            ...
            <ItemLayout className=" col-span-full xs:col-span-6 lg:col-span-4 text-accent">
                <p className="font-semibold text-2xl  sm:text-5xl text-left w-full">
            ...
            <ItemLayout className="col-span-full xs:col-span-6 lg:col-span-4 text-accent">
                ...
                <p className="font-semibold sm:text-5xl text-left w-full ">
                    +3 <sub className="font-semibold text-base sm:text-base"> years of experience</sub>
                </p>
        ...
        <ItemLayout className={"col-span-full sm:col-span-4 md:col-span-4 !p-0 "}>
           ...
           <ItemLayout className={"col-span-full sm:col-span-8 md:-col-span-6 !p-0"}>
